<script>
	...
	export default {
		globalData: {  
			serverUrl: "http://192.168.1.3:3000",		// 开发环境，不能使用localhost
				...
				var list = [
					{
						vlogId: "1001",
						vlogerId: "1001",
						vlogerFace: "http://39.105.208.107:9000/douyin/1675580905307.jpg",
						vlogerName: "zyxlwl",
						content: "zyxtest",
						url: 'https://mp-8f1bed8b-b47f-4da5-96e8-ba47967f40ee.cdn.bspapp.com/cloudstorage/4af6e186-a0fd-4de0-9428-178ccbef24cb.mp4',
						cover: 'https://mp-8f1bed8b-b47f-4da5-96e8-ba47967f40ee.cdn.bspapp.com/cloudstorage/4af6e186-a0fd-4de0-9428-178ccbef24cb.mp4?x-oss-process=video/snapshot,t_1,f_jpg,ar_auto',
						isLike: 1,
						play: false
					}
				];
